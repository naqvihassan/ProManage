...
public class MeetingsController extends BaseMeetingsController implements MeetingsLoader{
	    @FXML
	    ...
	    public void setDashboardController(ClientUIController dc) {
	    ...
	    public void loadScheduledMeetings() throws Exception {
	        ...
	        // Log the number of tasks
	        System.out.println("Client side Number of meetings: " + meetings.size());
